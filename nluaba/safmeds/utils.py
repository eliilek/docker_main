...
def report_practice_data(args):
	practice = Practice(student=args['student'], deck=Deck.objects.get(pk=args['deck']), practice_type=args['practice_type'])
	practice.duration = args['duration']
	practice.save()
