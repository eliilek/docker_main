...
urlpatterns = [
	...
	path('results/mark/<int:response>', views.mark, name='mark'),
	...
	path('feedback/release/<int:instance>', views.release_feedback, name='release_feedback'),
	path('feedback/release/<int:instance>/student', views.release_feedback, {"student":True}, name="release_feedback_student"),
	path('score/submit', views.score, name='score'),
	path('instance/<int:instance>/reenter', views.reenter, name='reenter'),
]
